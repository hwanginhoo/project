	...
	<c:choose>
		...
		<c:otherwise>
			...
			<tr>
				...
				<td style="text-align:center">${cdto.m_id}</td>
				<td style="text-align:center">${cdto.r_content}</td>
				<td style="text-align:center"><fmt:formatDate value="${cdto.r_regdate}" pattern="yyyy-MM-dd a HH:mm"/>
...
<script>
	...
	function updateComment(r_seq){
		location.href="updatecommentform.do?page=${cri.page}&perPageNum=${cri.perPageNum}&b_seq=${dto.b_seq}&r_seq="+r_seq;
	}
</script>
</body>
</html>